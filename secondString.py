...
#the newstring variable reverses the sentence string and returns every second letter. 
# [::-2] string slice, select the elements from the string array.
# string[start:stop:step] 
# Start and stop are the defaults and I increment going backwards by - 2.
